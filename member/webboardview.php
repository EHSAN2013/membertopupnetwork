...
<!-- Main Section -->
    ...
    <section class="main-section grid_8">
        ...
        <div class="main-content grid_8 alpha">
            ...
            <section>
            <fieldset><legend>ตอบกลับ #<?=$hj;?></legend>
            <div>
            	<?=$fetw['sw_detail'];?>
            </div>
			...
			mysql_close();
			echo "<script>window.location='index.php?step=webboardview&wid=$wid';</script>";
            ...
            <fieldset><legend>ตอบกลับ</legend>
                ...
                <p align="center">
                    <input type="submit" name="btneditc" value="ตอบกลับ" class="button button-orange" /> <input type="button" name="btnback" class="button button-gray" value="กลับไปดูกระทู้ทั้งหมด" onclick="javascript:window.location='index.php?step=webboard';" />
                </p>
            </fieldset>
            </form>
            </section>
