        ...
        <div class="main-content grid_7 alpha">
            <header>
                <div class="view-switcher">
                    ...
                    <ul>
                        <li><a href="admin_panel.php?page=webboard">ดูทุกกระทู้</a></li>
                        <li><a href="admin_panel.php?page=webboard&xlc=1">คนดูเยอะสุด</a></li>
                        <li class="separator"></li>
                        <li>เลือดูเฉพาะ...</li>
                        <li class="separator"></li>
                        <li><a href="admin_panel.php?page=webboard&xlc=2">วันนี้</a></li>
                        <li><a href="admin_panel.php?page=webboard&xlc=3">เดือนนี้</a></li>
                        <li><a href="admin_panel.php?page=webboard&xlc=4">ปีนี้</a></li>
                    </ul>
                </div>
            </header>
            <section>
				...
				$quertyuo.=" limit $start,$row_per_page";
				 $ghj=queryx2($quertyuo); $hj=0; while($fetw=mysql_fetch_array($ghj)){$hj++; ?>
                    <li class="clearfix">
                        ...
                        <a href="admin_panel.php?page=webboardview&wid=<?=$fetw['sw_id'];?>" class="name"><?=$fetw['sw_title'];?></a>
                        ...
                        <a href="admin_panel.php?page=deletes&dlt=<?=$fetw['sw_id'];?>&tld=2" class="button button-red fr" onclick="javascript:return confirm('ต้องการลบทิ้ง ?');">ลบทิ้ง<span class="bin"></span></a>
                        </div>
                    </li>
                 <? } ?>
                </ul>
			...
			echo "<script>window.location='admin_panel.php?page=webboardview&wid=$jidp';</script>";
			
			}?>
            <form action="" method="post" name="formboard" id="formboard" enctype="multipart/form-data">
            <fieldset><legend>ตั้งกระทู้ไหม่</legend>
                <p><label class="grid_1"><em>*</em> หัวข้อกระทู้</label> <input type="text" maxlength="400" name="sw_title" id="sw_title" size="88" required="required" /></p>
